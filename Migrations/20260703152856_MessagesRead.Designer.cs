...
namespace Calibr8Fit.Api.Migrations
{
    ...
    [Migration("20260703152856_MessagesRead")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Calibr8Fit.Api.Models.ChatMessageRead", b =>
                {
                    ...
                    b.HasKey("ChatMessageId", "UserId")
                        .HasName("pk_chat_message_reads");

                    b.HasIndex("ChatMessageId")
                        .HasDatabaseName("ix_chat_message_reads_chat_message_id");

                    b.HasIndex("UserId")
                        .HasDatabaseName("ix_chat_message_reads_user_id");
            ...
            modelBuilder.Entity("Calibr8Fit.Api.Models.ChatMessageRead", b =>
                {
                    b.HasOne("Calibr8Fit.Api.Models.ChatMessage", "ChatMessage")
                        .WithMany("Reads")
                        .HasForeignKey("ChatMessageId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_chat_message_reads_chat_messages_chat_message_id");

                    b.HasOne("Calibr8Fit.Api.Models.User", "User")
                        .WithMany("ChatMessageReads")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_chat_message_reads_users_user_id");
